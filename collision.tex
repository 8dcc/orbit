...
We can obtain the dot product of $V$ (the velocity of $B$) and $n$ (the
normalized impact vector we calculated earlier) to determine the amount of
velocity that was going towards $n$.
